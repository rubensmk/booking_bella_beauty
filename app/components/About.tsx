        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="text-beauty-dark/80 mb-4">
              ...
              preferences. This helps us tailor our approach specifically to
              you.
            </p>
            <p className="text-beauty-dark/80">
              Using premium products and the latest techniques, we ensure that
              you leave our salon not just with great hair, but with knowledge
              on how to maintain your style at home.
            </p>
            ...
            <div className="mt-8 space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-medium text-beauty-dark">
                    Personalized Consultation
                  </h4>
                  <p className="text-sm text-beauty-dark/70">
                    Every service begins with understanding your unique needs
                    and style goals
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-beauty-dark/70">
                    Our stylists receive continuous education on the latest
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-beauty-dark/70">
                    We use only high-quality, professional grade products for
                    optimal results
                  </p>
                </div>
              </div>
